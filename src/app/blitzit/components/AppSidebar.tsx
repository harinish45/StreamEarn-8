    ...
    return (
        <aside className="hidden md:flex flex-col w-64 bg-card p-4 border-r border-border">
            ...
            <nav className="flex-1 flex flex-col gap-2">
                {navItems.map((item) => (
                     <Button key={item.label} variant="ghost" className="justify-start gap-3 text-muted-foreground hover:text-foreground hover:bg-accent" asChild>
                        <Link href={item.href}>
            ...
            <div className="flex flex-col gap-2 border-t border-border pt-4">
                 <Button variant="ghost" className="justify-start gap-3 text-muted-foreground hover:text-foreground hover:bg-accent">

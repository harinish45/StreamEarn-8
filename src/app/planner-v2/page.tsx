...
export default function PlannerV2(){
  ...
  const reset=()=>{if(confirm('Reset Planner data on this device?')){try{window.localStorage.removeItem(KEY);window.localStorage.removeItem('streamearn-planner-v5');}catch{} setStore(fresh());}};

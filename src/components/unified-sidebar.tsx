...
import { Bot, BriefcaseBusiness, Compass, GraduationCap, LayoutDashboard, Library, Newspaper, Search, ShieldCheck, Sparkles, WalletCards } from 'lucide-react';
...
export function UnifiedSidebar() {
  ...
  return <Sidebar variant="inset" collapsible="icon">
    ...
    <SidebarContent className="px-2">
      <div className="mb-3 flex items-center gap-2 rounded-lg border bg-card px-3 py-2 text-xs text-muted-foreground"><Search className="h-3.5 w-3.5" /><span className="group-data-[collapsible=icon]:hidden">Search StreamEarn</span></div>

...
export const illegalAiTools: AiToolCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Submagic', logo: createLogo('Submagic'), link: 'https://www.submagic.io/' },
      { name: 'Krea AI', logo: createLogo('Krea AI'), link: 'https://www.krea.ai/' },
      { name: 'Emergent', logo: createLogo('Emergent-video'), link: 'https://emergent.sh' },
      { name: 'MGX', logo: createLogo('MGX-video'), link: 'https://mgx.dev' },
    ],
  },
  {

...
export async function updateProject(id:string,patch:Record<string,unknown>){const data=await callEdge('update',{id,patch});return fromRow(data,Array.isArray(data.people)?data.people:[]);}

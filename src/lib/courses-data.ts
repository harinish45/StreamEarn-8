...
export const coursesData: CourseCategory[] = [
 { id:'official-academies', name:'Official AI Academies', courses:[
  c('anthropic-academy','Anthropic Academy','Official learning hub for AI development, work adoption, skills, research and responsible use.','https://www.anthropic.com/learn','Anthropic','Beginner','BookOpen','Official academy'),
  ...
  c('openai-builder-bootcamp-agents','Builder Bootcamp: Agents','Official builder session covering tools, instructions, handoffs, routing, guardrails, tracing and evaluation for production agents.','https://academy.openai.com/public/clubs/builders-etkn1/events/builder-bootcamp-agents-dnn3r6iuhf','OpenAI Academy','Advanced','Workflow','Live session'),
  c('openai-codex-bootcamp','Codex Bootcamp','Three-part official series covering agentic coding, team workflows and advanced automation for technical builders.','https://academy.openai.com/public/clubs/builders-etkn1/resources/codex-bootcamp-2026-09-23','OpenAI Academy','Advanced','Code','Live series'),
  c('google-ai-essentials','Google AI Essentials','Practical course covering AI basics, productivity, prompting, responsible use and current AI skills.','https://grow.google/intl/en_in/ai-essentials/','Google','Beginner','GraduationCap','Certificate'),
  c('google-ai-professional-certificate','Google AI Professional Certificate','Advanced practical AI skills with hands-on activities designed to build workplace AI fluency.','https://grow.google/ai-professional/','Google','Intermediate','GraduationCap','Professional certificate'),
  c('google-build-with-gemini-2026','Build with Gemini 2026','Hands-on Google Cloud workshop for building, scaling and deploying secure production-ready AI agents.','https://cloud.google.com/events/build-with-gemini-2026','Google Cloud','Advanced','Cloud','Hands-on workshop'),
 ...
 { id:'agents-agentic', name:'Agents & Agent Engineering', courses:[
  ...
  c('hf-context-course','Context Course','Free hands-on learning for agent context, MCP, skills, plugins, subagents, hooks and agent-driven ML work.','https://huggingface.co/context-course','Hugging Face','Advanced','Workflow','Course'),
 ...
 { id:'developer-ai', name:'AI Development & Application Building', courses:[
  ...
  c('google-ai-skills','Google AI Skills','Current official catalog of AI courses, skill badges and advanced learning paths from Google.','https://ai.google/education','Google','Intermediate','GraduationCap','Learning hub'),
 ...
 { id:'cyber-ai', name:'AI Security, Governance & Responsible Use', courses:[
  c('google-responsible-ai','Responsible AI Foundations','Practical responsible-AI skills covering limitations, safety and responsible application.','https://ai.google/education','Google','Beginner','ShieldCheck','Learning hub'),

...
export const curatedResources: CuratedResource[] = [
  ...
  { id: 'nvidia-certifications', title: 'NVIDIA Certification', url: 'https://www.nvidia.com/en-in/learn/certification/', description: 'Current NVIDIA certification portfolio covering AI infrastructure, generative AI, data science and physical AI.', category: 'AI Learning', tags: ['NVIDIA','Certification','AI Infrastructure'], featured: true },
...
export const featuredCourses = [
  { id: 'hf-context-2026', title: 'Hugging Face Context Course', url: 'https://huggingface.co/context-course', provider: 'Hugging Face', description: 'Advanced context engineering covering agent skills, MCP, plugins, sub-agents, hooks and hands-on ML projects.' },
  ...
  { id: 'nvidia-certification-2026', title: 'NVIDIA Certification — Generative AI & Agentic AI', url: 'https://www.nvidia.com/en-in/learn/certification/', provider: 'NVIDIA', description: 'Current certification paths for generative AI, agentic AI and AI infrastructure, with associate and professional levels.' },

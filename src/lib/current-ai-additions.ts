...
export const currentAIAdditions: CurrentAICategory[] = [
  {
    id: 'assistants-research-2026',
    name: 'Current Assistants & Research',
    description: 'Current assistants and research products verified against active product pages.',
    tools: [
  ...
  },
  {
    ...
    name: 'Agents & Task Delegation',
    description: 'Current products for delegated multi-step work and agentic workflows.',
    tools: [
  ...
  {
    id: 'coding-agents-2026',
    name: 'Coding Agents & Developer Tools',
    description: 'Current coding agents, IDEs and terminal workflows.',
    tools: [
  ...
  {
    id: 'gtm-lead-automation-2026',
    name: 'GTM, Sales & Lead Automation',
    description: 'Current platforms for prospecting, enrichment, research, signals and automated GTM workflows.',
    tools: [
  ...
  {
    id: 'creative-media-2026',
    name: 'Creative, Design & Media',
    description: 'Current creative platforms for visual, video, design and voice production.',
    tools: [
  ...
  {
    id: 'security-evals-2026',
    name: 'AI Security, Evaluation & Observability',
    description: 'Security guidance and production controls for AI and agentic applications.',
    tools: [
  ...
  },
  {
    ...
    description: 'Current infrastructure for inference, model serving and enterprise AI deployment.',
    tools: [

...
export const currentAIAdditions: CurrentAICategory[] = [
  {
    ...
    description: 'Newer AI workspaces and agent products for long-running research, knowledge work, desktop workflows and advanced task execution.',
    tools: [
      ...
      { name: 'Anthropic Academy', url: 'https://www.anthropic.com/learn', summary: 'Official learning hub for AI development, enterprise adoption, skills, research and tool use.', tags: ['learning', 'official', 'development'] },
      { name: 'OpenAI Academy', url: 'https://academy.openai.com/', summary: 'Official practical AI learning covering foundations, applied workflows, agents and work skills.', tags: ['learning', 'official', 'agents'] },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: 'DeepLearning.AI Agentic AI', url: 'https://www.deeplearning.ai/courses/agentic-ai', summary: 'Intermediate practical course on reflection, tool use, planning, multi-agent workflows and evaluation.', tags: ['learning', 'agents', 'python'] },
      ...
      { name: 'NVIDIA AI Learning Paths', url: 'https://www.nvidia.com/en-us/learn/learning-paths/', summary: 'Technical learning paths covering generative AI, agentic AI, infrastructure and professional credentials.', tags: ['learning', 'infrastructure', 'certification'] },
    ],
  },
];
